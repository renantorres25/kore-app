          ...
          <>
            <div className="grid grid-cols-4 gap-2 mb-4">
              {[
                ...
                <div key={i} className="rounded-2xl p-3 border border-white/[0.11] text-center" style={{ background: '#1e293b' }}>
            ...
            {planosNutri.length >= 1 && (() => {
              ...
              return (
                <div className="rounded-2xl border border-orange-500/10 mb-4 overflow-hidden" style={{ background: '#1e293b' }}>
                  <div className="px-5 pt-5 pb-5">
