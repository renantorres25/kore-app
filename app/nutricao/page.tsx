...
function AbaPlano({ plano, gerandoPlano, vinculoNutri, onIniciarConsulta }: {
  ...
  if (plano) {
    ...
    return (
      <div className="pb-6">
        ...
        <div className="mx-4 mb-4 rounded-2xl border border-white/[0.11] overflow-hidden" style={{ background: '#131b2e' }}>
        ...
        {e ? (
          <div className="px-4 space-y-3">
            {e.refeicoes.map((ref, i) => {
              ...
              return (
                <div key={i} className="rounded-2xl border border-white/[0.11] overflow-hidden" style={{ background: '#131b2e' }}>
            ...
            {e.suplementos && e.suplementos.length > 0 && (
              <div className="rounded-2xl border border-purple-500/20 overflow-hidden" style={{ background: '#131b2e' }}>
            ...
            {e.hidratacao && (
              <div className="rounded-2xl border border-cyan-500/20 overflow-hidden" style={{ background: '#131b2e' }}>
          ...
          <div className="mx-4 rounded-2xl border border-white/[0.11] p-5" style={{ background: '#131b2e' }}>
  ...
  return (
    <div className="px-4 pt-4">
      <div className="rounded-2xl border border-emerald-500/20 p-5" style={{ background: '#131b2e' }}>
        <div className="flex items-center gap-3">
...
3 parágrafos curtos, máx 80 palavras total, sem markdown, sem títulos em maiúsculas, tom de coach direto:`
  ...
  return (
    <div className="px-4 pt-4 space-y-4 pb-4">
      ...
      <div className="rounded-2xl border border-emerald-500/20 overflow-hidden" style={{ background: '#131b2e' }}>
      ...
      <div className="rounded-2xl border border-white/[0.11] p-4" style={{ background: '#131b2e' }}>
        <div className="flex items-center gap-3">
