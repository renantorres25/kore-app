      ...
      <div className="max-w-md mx-auto px-4 pb-28" style={{ paddingTop: 'max(3rem, calc(env(safe-area-inset-top) + 1.5rem))' }}>
        ...
        {editando && (
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-indigo-500/20 p-5" style={{ background: '#1e293b' }}>
        ...
        {!editando && (
          <div className="rounded-2xl border border-white/[0.11] p-5 mt-4" style={{ background: '#1e293b' }}>
