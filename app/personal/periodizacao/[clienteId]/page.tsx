    ...
    <main className="min-h-[100dvh] bg-[#0d1117] text-white">
      <div className="max-w-md mx-auto px-4 pb-28" style={{ paddingTop: 'max(3rem, calc(env(safe-area-inset-top) + 1.5rem))' }}>
        ...
        {periodizacao && semanaAtual && semanaAtual.blocoIdx < periodizacao.blocos.length && (() => {
          ...
          return (
            <div className={`rounded-2xl p-5 border ${cfg.border} mb-5`} style={{ background: '#1e293b' }}>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className={`font-black text-xl ${cfg.text}`}>{b.nome}</p>
        ...
        {/* Formulário */}
        {criando && (
          <div ref={formRef} className="rounded-2xl border border-white/[0.14] overflow-hidden" style={{ background: '#1e293b' }}>
            <div className="px-5 py-4 border-b border-white/[0.14]">
