  ...
  return (
    <main className="min-h-[100dvh] bg-[#0d1117] text-white flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        {/* Expirado */}
        {estado === 'expirado' && (
          <div className="rounded-2xl p-8 border border-yellow-500/20 text-center" style={{ background: '#1e293b' }}>
        ...
        {/* Inválido */}
        {estado === 'invalido' && (
          <div className="rounded-2xl p-8 border border-white/[0.11] text-center" style={{ background: '#1e293b' }}>
        ...
        {/* Válido */}
        {estado === 'valido' && (
          <div className="rounded-2xl p-8 border border-white/[0.11]" style={{ background: '#1e293b' }}>
        ...
        {/* Erro */}
        {estado === 'erro' && (
          <div className="rounded-2xl p-8 border border-red-500/20 text-center" style={{ background: '#1e293b' }}>
            <div className="text-4xl mb-4">❌</div>
