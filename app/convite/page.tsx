  ...
  return (
    <main className="min-h-[100dvh] bg-[#0d1117] text-white">
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        <div className="rounded-2xl p-5 border border-white/[0.11] mb-6" style={{ background: '#1e293b' }}>
          ...
          <div className="mt-8">
            ...
            <div className="space-y-2">
              {convitesPendentes.map(c => {
                ...
                return (
                  <div key={c.id} className="flex items-center gap-3 rounded-xl border border-white/[0.11] px-4 py-3" style={{ background: '#1e293b' }}>
